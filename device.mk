...
# Needed in recovery
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/twrp.fstab.emmc:recovery/root/etc/twrp.fstab.emmc \
    $(LOCAL_PATH)/twrp.fstab.sata:recovery/root/etc/twrp.fstab.sata \
    $(LOCAL_PATH)/tegra21x_xusb_firmware:recovery/root/etc/firmware/tegra21x_xusb_firmware
